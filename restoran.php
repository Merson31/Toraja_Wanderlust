...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover"  style="background-image: url(images/restoran.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
							...
							<div class="desc2 animate-box">
									...
									<span class="price">Destinasi Restoran Terbaik</span> <br>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Rekomendasi Destinasi Restoran yang Menarik</p>
					</div>
				</div>
						...
						<div class="fh5co-blog animate-box">
							...
							<div class="blog-text">
								<div class="prod-title">
									<h3><a href="#"><?php echo $x['restoran']; ?></a></h3>
										<span>RP<?php echo $x['harga_menu']; ?></span>
									<p><a  href="tampilanrestoran.php?id=<?php echo $x['id_restoran'] ?>">Learn More...</a></p>
								</div>
							</div> 
						</div>
					</div>
