...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $namahotel = $conn->real_escape_string($namahotel);
    ...
    $sql = "UPDATE tbl_hotel SET hotel = '$namahotel', harga = '$harga', ket_hotel = '$keterangan', foto = '$gambar' WHERE id_hotel = '$id'";
...
} elseif (isset($_GET['id_hotel']) && is_numeric($_GET['id_hotel'])) {
    $id = $_GET['id_hotel'];
    ...
    $sql = "SELECT * FROM tbl_hotel WHERE id_hotel = '$id'";
  ...
  <div class="form-container">
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="namahotel" name="namahotel" value="<?php echo $namahotel; ?>" required>
      </div>
      <div class="form-group">
