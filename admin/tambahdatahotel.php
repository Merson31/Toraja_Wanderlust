...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT MAX(id_hotel) AS max_id FROM tbl_hotel";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $no = $row['max_id'] + 1;

    // Query untuk menambahkan data
    $sql = "INSERT INTO tbl_hotel (id_hotel, hotel, harga, ket_hotel, foto) VALUES ('$no', '$namahotel', '$harga', '$keterangan', '$gambar')";
